...
function MaxRange(props) {
    ...
    return (
        <div className={classes.root}>
            ...
            <LinearProgress className={classes.progressBar} classes={{ colorPrimary: classes.linearColorPrimary, barColorPrimary: classes.linearBarColorPrimary }} variant="determinate" color="primary" value={normalize(props.value)} />
        </div>
    )
}
